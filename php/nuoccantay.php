...
$sql = "SELECT * FROM sanpham WHERE ten = 'Nước Ép Cần Tây' LIMIT 1";
...
function sendMessage() {
    ...
    <div class="bread-crumbs"> 
        <p>
            ...
            <a href="../thanhloc3.html">JUICE AND SMOOTHIE/</a>
            <span> NƯỚC ÉP CẦN TÂY</span>
        </p>
    </div>
    <!-- SLIDE Detox 3 ngày-->
